<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DedicatedStationLabels.aspx.vb" Inherits="DedicatedStationLabels" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Dedicated Labels</title>
...
<body>
    ...
    <div>
        ...
        <asp:DataList ID="DataList1" runat="server" DataSourceID="vRefinedPrintDetails" RepeatColumns="2"
            RepeatDirection="Horizontal" Width="8.2in" BackColor="LightBlue" 
            CellSpacing="10">
            <ItemTemplate>
            <div class="dedicated">
                ...
                <div class="other_info" style="width: 79%; height: 100%">
                    Any staff member can use this device,<br />
                    &nbsp; &nbsp;when it's not occupied by the primary use(r).<br />
                    <b>Important Info:</b><br />
                    Tech Support:
                    <br />
                     <strong style="color: black;">techsupport@seward.coop</strong>  <strong style="color: red;">Ph:(612)547-6972</strong><br />
                    MN Digerati tech support phone:<br />
                    1(800)477-3494<br />
        ...
        <asp:SqlDataSource ID="vRefinedPrintDetails" runat="server" ConnectionString="<%$ ConnectionStrings:WorkstationsConnectionString %>"
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="Dedicated" Name="Workstation_Type" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
