<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Devices.aspx.vb" Inherits="Devices" %>
                ...
                <asp:TemplateField HeaderText="Workstation Description" SortExpression="PrimaryUse">
                    <EditItemTemplate>
                        <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="workstationsDataSource"
                            DataTextField="PrimaryUse" DataValueField="worstationCode" SelectedValue='<%# Bind("workstationID") %>'
                            Width="204px">
                        </asp:DropDownList>
                    </EditItemTemplate>
                    <ItemTemplate>
